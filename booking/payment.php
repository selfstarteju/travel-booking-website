	...
	<body>
		...
		<div class="col-sm-12 paymentWrapper">
			...
			<div class="col-sm-6">
				...
				<form action="../tickets/generateTicket.php" method="POST">
				...
				<form action="../tickets/generateReceipt.php" method="POST">
				...
				<form action="../tickets/generateTrainTicket.php" method="POST">
