	...
	<body>
		...
		<div class="col-sm-5 contactUsExtras">
			...
			<div class="col-sm-12 heading">
				...
				<br>
				<h4>Shrigonda, Maharashtra, India</h4>
				<br>
				<span class="bold"><h2>Email Us:</h2></span>
				<br>
				<h4>bhagyashreemane46@gmail.com</h4>
				<h4>vaishnavisudrik7@gmail.com</h4>
				<br>
				<span class="bold"><h2>Call Us:</h2></span>
				<br>
				<h4>+91 9637787041</h4>
				<h4>+91 9322037722</h4>
			</div>
		...
		<div class="col-sm-5 contactUsForm">
			...
			<form id="contactForm" action="contactUsAction.php" method="POST">
