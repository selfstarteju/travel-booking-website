			...
			<div class="col-sm-12">
				...
				<div class="header">
					...
					if(!isset($_SESSION["username"])) {
						include("common/headerTransparentLoggedOutRoot.php");
					}
					else {
						include("common/headerTransparentLoggedInRoot.php");
					}
			...
			<div class="col-xs-12 popularDestinationsContainer">
				...
				<div class="col-xs-12 destinationHolder">
					...
					<div class="col-xs-12 containerGrids hvr-buzz-out">
						...
						<a href="hotels/hotels.php" style="color: black;">
					...
					<div class="col-xs-12 containerGrids hvr-buzz-out">
						<a href="flights/flights.php" style="color: black;">
					...
					<div class="col-xs-12 containerGrids hvr-buzz-out">
						<a href="trains/trains.php" style="color: black;">
		...
		<!-- FOOTER SECTION STARTS -->
				...
				<div class="footerMod col-sm-12">
					...
					<div class="col-sm-4">
						...
						<div class="footerText">
							E-mails:<br> bhagyashreemane46@gmail.com <br> vaishnavisudrik7@gmail.com
						</div>
						
						<div class="footerText">
							Phone:<br> +91 9637787041 <br> +91 9322037722
						</div>
